...
class FinalInputs(PassIn, tk.Frame):
    def __init__(self, parent, controller):
        ...
        #controller.geometry("1000x700")  # Set window size
        self.tkraise()  # Bring frame to front
        
        self.render(parent, controller)

    def render(self, parent, controller): # automatically runs
        ...
        cell1Mass_entry = tk.Entry(cell1_frame, textvariable=controller.shared_data["main_frame"]["cell1"]["mass"], font = ("arial", 14, "bold"), width=4, bg="white", fg="gray1").grid(row=0, column=1)
        cell1Count_entry = tk.Entry(cell1_frame, textvariable=controller.shared_data["main_frame"]["cell1"]["count"], font = ("arial", 14, "bold"), width=4, bg="white", fg="gray1").grid(row=1, column=1)
        cell1Diameter1_entry = tk.Entry(cell1_frame, textvariable=controller.shared_data["main_frame"]["cell1"]["diameter1"], font = ("arial", 14, "bold"), width=4, bg="white", fg="gray1").grid(row=2, column=1)
        cell1Diameter2_entry = tk.Entry(cell1_frame, textvariable=controller.shared_data["main_frame"]["cell1"]["diameter2"], font = ("arial", 14, "bold"), width=3, bg="white", fg="gray1").grid(row=2, column=2)
        cell1Diameter3_entry = tk.Entry(cell1_frame, textvariable=controller.shared_data["main_frame"]["cell1"]["diameter3"], font = ("arial", 14, "bold"), width=3, bg="white", fg="gray1").grid(row=2, column=3)
        cell1Diameter4_entry = tk.Entry(cell1_frame, textvariable=controller.shared_data["main_frame"]["cell1"]["diameter4"], font = ("arial", 14, "bold"), width=3, bg="white", fg="gray1").grid(row=2, column=4)
        ''' end '''
        ...
        cell2Mass_entry = tk.Entry(cell2_frame, textvariable=controller.shared_data["main_frame"]["cell2"]["mass"], font = ("arial", 14, "bold"), width=4, bg="white", fg="gray1").grid(row=0, column=1)
        cell2Count_entry = tk.Entry(cell2_frame, textvariable=controller.shared_data["main_frame"]["cell2"]["count"], font = ("arial", 14, "bold"), width=4, bg="white", fg="gray1").grid(row=1, column=1)
        cell2Diameter1_entry = tk.Entry(cell2_frame, textvariable=controller.shared_data["main_frame"]["cell2"]["diameter1"], font = ("arial", 14, "bold"), width=4, bg="white", fg="gray1").grid(row=2, column=1)
        cell2Diameter2_entry = tk.Entry(cell2_frame, textvariable=controller.shared_data["main_frame"]["cell2"]["diameter2"], font = ("arial", 14, "bold"), width=3, bg="white", fg="gray1").grid(row=2, column=2)
        cell2Diameter3_entry = tk.Entry(cell2_frame, textvariable=controller.shared_data["main_frame"]["cell2"]["diameter3"], font = ("arial", 14, "bold"), width=3, bg="white", fg="gray1").grid(row=2, column=3)
        cell2Diameter4_entry = tk.Entry(cell2_frame, textvariable=controller.shared_data["main_frame"]["cell2"]["diameter4"], font = ("arial", 14, "bold"), width=3, bg="white", fg="gray1").grid(row=2, column=4)
        ''' end '''
        ...
        cell3Mass_entry = tk.Entry(cell3_frame, textvariable=controller.shared_data["main_frame"]["cell3"]["mass"], font = ("arial", 14, "bold"), width=4, bg="white", fg="gray1").grid(row=0, column=1)
        cell3Count_entry = tk.Entry(cell3_frame, textvariable=controller.shared_data["main_frame"]["cell3"]["count"], font = ("arial", 14, "bold"), width=4, bg="white", fg="gray1").grid(row=1, column=1)
        cell3Diameter1_entry = tk.Entry(cell3_frame, textvariable=controller.shared_data["main_frame"]["cell3"]["diameter1"], font = ("arial", 14, "bold"), width=4, bg="white", fg="gray1").grid(row=2, column=1)
        cell3Diameter2_entry = tk.Entry(cell3_frame, textvariable=controller.shared_data["main_frame"]["cell3"]["diameter2"], font = ("arial", 14, "bold"), width=3, bg="white", fg="gray1").grid(row=2, column=2)
        cell3Diameter3_entry = tk.Entry(cell3_frame, textvariable=controller.shared_data["main_frame"]["cell3"]["diameter3"], font = ("arial", 14, "bold"), width=3, bg="white", fg="gray1").grid(row=2, column=3)
        cell3Diameter4_entry = tk.Entry(cell3_frame, textvariable=controller.shared_data["main_frame"]["cell3"]["diameter4"], font = ("arial", 14, "bold"), width=3, bg="white", fg="gray1").grid(row=2, column=4)
        ''' end '''
        ...
        cell4Mass_entry = tk.Entry(cell4_frame, textvariable=controller.shared_data["main_frame"]["cell4"]["mass"], font = ("arial", 14, "bold"), width=4, bg="white", fg="gray1").grid(row=0, column=1)
        cell4Count_entry = tk.Entry(cell4_frame, textvariable=controller.shared_data["main_frame"]["cell4"]["count"], font = ("arial", 14, "bold"), width=4, bg="white", fg="gray1").grid(row=1, column=1)
        cell4Diameter1_entry = tk.Entry(cell4_frame, textvariable=controller.shared_data["main_frame"]["cell4"]["diameter1"], font = ("arial", 14, "bold"), width=4, bg="white", fg="gray1").grid(row=2, column=1)
        cell4Diameter2_entry = tk.Entry(cell4_frame, textvariable=controller.shared_data["main_frame"]["cell4"]["diameter2"], font = ("arial", 14, "bold"), width=3, bg="white", fg="gray1").grid(row=2, column=2)
        cell4Diameter3_entry = tk.Entry(cell4_frame, textvariable=controller.shared_data["main_frame"]["cell4"]["diameter3"], font = ("arial", 14, "bold"), width=3, bg="white", fg="gray1").grid(row=2, column=3)
        cell4Diameter4_entry = tk.Entry(cell4_frame, textvariable=controller.shared_data["main_frame"]["cell4"]["diameter4"], font = ("arial", 14, "bold"), width=3, bg="white", fg="gray1").grid(row=2, column=4)
        ''' end '''
        ...
        cell5Mass_entry = tk.Entry(cell5_frame, textvariable=controller.shared_data["main_frame"]["cell5"]["mass"], font = ("arial", 14, "bold"), width=4, bg="white", fg="gray1").grid(row=0, column=1)
        cell5Count_entry = tk.Entry(cell5_frame, textvariable=controller.shared_data["main_frame"]["cell5"]["count"], font = ("arial", 14, "bold"), width=4, bg="white", fg="gray1").grid(row=1, column=1)
        cell5Diameter1_entry = tk.Entry(cell5_frame, textvariable=controller.shared_data["main_frame"]["cell5"]["diameter1"], font = ("arial", 14, "bold"), width=4, bg="white", fg="gray1").grid(row=2, column=1)
        cell5Diameter2_entry = tk.Entry(cell5_frame, textvariable=controller.shared_data["main_frame"]["cell5"]["diameter2"], font = ("arial", 14, "bold"), width=3, bg="white", fg="gray1").grid(row=2, column=2)
        cell5Diameter3_entry = tk.Entry(cell5_frame, textvariable=controller.shared_data["main_frame"]["cell5"]["diameter3"], font = ("arial", 14, "bold"), width=3, bg="white", fg="gray1").grid(row=2, column=3)
        cell5Diameter4_entry = tk.Entry(cell5_frame, textvariable=controller.shared_data["main_frame"]["cell5"]["diameter4"], font = ("arial", 14, "bold"), width=3, bg="white", fg="gray1").grid(row=2, column=4)
        ''' end '''
        ...
        cell6Mass_entry = tk.Entry(cell6_frame, textvariable=controller.shared_data["main_frame"]["cell6"]["mass"], font = ("arial", 14, "bold"), width=4, bg="white", fg="gray1").grid(row=0, column=1)
        cell6Count_entry = tk.Entry(cell6_frame, textvariable=controller.shared_data["main_frame"]["cell6"]["count"], font = ("arial", 14, "bold"), width=4, bg="white", fg="gray1").grid(row=1, column=1)
        cell6Diameter1_entry = tk.Entry(cell6_frame, textvariable=controller.shared_data["main_frame"]["cell6"]["diameter1"], font = ("arial", 14, "bold"), width=4, bg="white", fg="gray1").grid(row=2, column=1)
        cell6Diameter2_entry = tk.Entry(cell6_frame, textvariable=controller.shared_data["main_frame"]["cell6"]["diameter2"], font = ("arial", 14, "bold"), width=3, bg="white", fg="gray1").grid(row=2, column=2)
        cell6Diameter3_entry = tk.Entry(cell6_frame, textvariable=controller.shared_data["main_frame"]["cell6"]["diameter3"], font = ("arial", 14, "bold"), width=3, bg="white", fg="gray1").grid(row=2, column=3)
        cell6Diameter4_entry = tk.Entry(cell6_frame, textvariable=controller.shared_data["main_frame"]["cell6"]["diameter4"], font = ("arial", 14, "bold"), width=3, bg="white", fg="gray1").grid(row=2, column=4)
        ''' end '''
        ...
        cell7Mass_entry = tk.Entry(cell7_frame, textvariable=controller.shared_data["main_frame"]["cell7"]["mass"], font = ("arial", 14, "bold"), width=4, bg="white", fg="gray1").grid(row=0, column=1)
        cell7Count_entry = tk.Entry(cell7_frame, textvariable=controller.shared_data["main_frame"]["cell7"]["count"], font = ("arial", 14, "bold"), width=4, bg="white", fg="gray1").grid(row=1, column=1)
        cell7Diameter1_entry = tk.Entry(cell7_frame, textvariable=controller.shared_data["main_frame"]["cell7"]["diameter1"], font = ("arial", 14, "bold"), width=4, bg="white", fg="gray1").grid(row=2, column=1)
        cell7Diameter2_entry = tk.Entry(cell7_frame, textvariable=controller.shared_data["main_frame"]["cell7"]["diameter2"], font = ("arial", 14, "bold"), width=3, bg="white", fg="gray1").grid(row=2, column=2)
        cell7Diameter3_entry = tk.Entry(cell7_frame, textvariable=controller.shared_data["main_frame"]["cell7"]["diameter3"], font = ("arial", 14, "bold"), width=3, bg="white", fg="gray1").grid(row=2, column=3)
        cell7Diameter4_entry = tk.Entry(cell7_frame, textvariable=controller.shared_data["main_frame"]["cell7"]["diameter4"], font = ("arial", 14, "bold"), width=3, bg="white", fg="gray1").grid(row=2, column=4)
        ''' end '''
        ...
        cell8Mass_entry = tk.Entry(cell8_frame, textvariable=controller.shared_data["main_frame"]["cell8"]["mass"], font = ("arial", 14, "bold"), width=4, bg="white", fg="gray1").grid(row=0, column=1)
        cell8Count_entry = tk.Entry(cell8_frame, textvariable=controller.shared_data["main_frame"]["cell8"]["count"], font = ("arial", 14, "bold"), width=4, bg="white", fg="gray1").grid(row=1, column=1)
        cell8Diameter1_entry = tk.Entry(cell8_frame, textvariable=controller.shared_data["main_frame"]["cell8"]["diameter1"], font = ("arial", 14, "bold"), width=4, bg="white", fg="gray1").grid(row=2, column=1)
        cell8Diameter2_entry = tk.Entry(cell8_frame, textvariable=controller.shared_data["main_frame"]["cell8"]["diameter2"], font = ("arial", 14, "bold"), width=3, bg="white", fg="gray1").grid(row=2, column=2)
        cell8Diameter3_entry = tk.Entry(cell8_frame, textvariable=controller.shared_data["main_frame"]["cell8"]["diameter3"], font = ("arial", 14, "bold"), width=3, bg="white", fg="gray1").grid(row=2, column=3)
        cell8Diameter4_entry = tk.Entry(cell8_frame, textvariable=controller.shared_data["main_frame"]["cell8"]["diameter4"], font = ("arial", 14, "bold"), width=3, bg="white", fg="gray1").grid(row=2, column=4)
        ''' end '''
        ...
        cell9Mass_entry = tk.Entry(cell9_frame, textvariable=controller.shared_data["main_frame"]["cell9"]["mass"], font = ("arial", 14, "bold"), width=4, bg="white", fg="gray1").grid(row=0, column=1)
        cell9Count_entry = tk.Entry(cell9_frame, textvariable=controller.shared_data["main_frame"]["cell9"]["count"], font = ("arial", 14, "bold"), width=4, bg="white", fg="gray1").grid(row=1, column=1)
        cell9Diameter1_entry = tk.Entry(cell9_frame, textvariable=controller.shared_data["main_frame"]["cell9"]["diameter1"], font = ("arial", 14, "bold"), width=4, bg="white", fg="gray1").grid(row=2, column=1)
        cell9Diameter2_entry = tk.Entry(cell9_frame, textvariable=controller.shared_data["main_frame"]["cell9"]["diameter2"], font = ("arial", 14, "bold"), width=3, bg="white", fg="gray1").grid(row=2, column=2)
        cell9Diameter3_entry = tk.Entry(cell9_frame, textvariable=controller.shared_data["main_frame"]["cell9"]["diameter3"], font = ("arial", 14, "bold"), width=3, bg="white", fg="gray1").grid(row=2, column=3)
        cell9Diameter4_entry = tk.Entry(cell9_frame, textvariable=controller.shared_data["main_frame"]["cell9"]["diameter4"], font = ("arial", 14, "bold"), width=3, bg="white", fg="gray1").grid(row=2, column=4)
        ''' end '''
    ...
    def savePostTestInputs(self):   
        ...
        filename_postTest_csv = self.gui_main_object.address + '/' + (self.controller.shared_data["main_frame"]["filename_postTest"]
.get()) + '.csv'
     
        FinalInputs.mass1 = [controller.shared_data["main_frame"]["cell1"]["mass"].get()] # TypeError: 'float' object is not iterable
        FinalInputs.mass2 = [controller.shared_data["main_frame"]["cell2"]["mass"].get()]
        FinalInputs.mass3 = [controller.shared_data["main_frame"]["cell3"]["mass"].get()]
        FinalInputs.mass4 = [controller.shared_data["main_frame"]["cell4"]["mass"].get()]
        FinalInputs.mass5 = [controller.shared_data["main_frame"]["cell5"]["mass"].get()]
        FinalInputs.mass6 = [controller.shared_data["main_frame"]["cell6"]["mass"].get()]
        FinalInputs.mass7 = [controller.shared_data["main_frame"]["cell7"]["mass"].get()]
        FinalInputs.mass8 = [controller.shared_data["main_frame"]["cell8"]["mass"].get()]
        FinalInputs.mass9 = [controller.shared_data["main_frame"]["cell9"]["mass"].get()]
        FinalInputs.count1 = [controller.shared_data["main_frame"]["cell1"]["count"].get()] # TypeError: 'float' object is not iterable
        FinalInputs.count2 = [controller.shared_data["main_frame"]["cell2"]["count"].get()]
        FinalInputs.count3 = [controller.shared_data["main_frame"]["cell3"]["count"].get()]
        FinalInputs.count4 = [controller.shared_data["main_frame"]["cell4"]["count"].get()]
        FinalInputs.count5 = [controller.shared_data["main_frame"]["cell5"]["count"].get()]
        FinalInputs.count6 = [controller.shared_data["main_frame"]["cell6"]["count"].get()]
        FinalInputs.count7 = [controller.shared_data["main_frame"]["cell7"]["count"].get()]
        FinalInputs.count8 = [controller.shared_data["main_frame"]["cell8"]["count"].get()]
        FinalInputs.count9 = [controller.shared_data["main_frame"]["cell9"]["count"].get()]

        FinalInputs.diam1 = [controller.shared_data["main_frame"]["cell1"]["diameter1"].get(),controller.shared_data["main_frame"]["cell1"]["diameter2"].get(),controller.shared_data["main_frame"]["cell1"]["diameter3"].get(),controller.shared_data["main_frame"]["cell1"]["diameter4"].get()]
        FinalInputs.diam2 = [controller.shared_data["main_frame"]["cell2"]["diameter1"].get(),controller.shared_data["main_frame"]["cell2"]["diameter2"].get(),controller.shared_data["main_frame"]["cell2"]["diameter3"].get(),controller.shared_data["main_frame"]["cell2"]["diameter4"].get()]
        FinalInputs.diam3 = [controller.shared_data["main_frame"]["cell3"]["diameter1"].get(),controller.shared_data["main_frame"]["cell3"]["diameter2"].get(),controller.shared_data["main_frame"]["cell3"]["diameter3"].get(),controller.shared_data["main_frame"]["cell3"]["diameter4"].get()]
        FinalInputs.diam4 = [controller.shared_data["main_frame"]["cell4"]["diameter1"].get(),controller.shared_data["main_frame"]["cell4"]["diameter2"].get(),controller.shared_data["main_frame"]["cell4"]["diameter3"].get(),controller.shared_data["main_frame"]["cell4"]["diameter4"].get()]
        FinalInputs.diam5 = [controller.shared_data["main_frame"]["cell5"]["diameter1"].get(),controller.shared_data["main_frame"]["cell5"]["diameter2"].get(),controller.shared_data["main_frame"]["cell5"]["diameter3"].get(),controller.shared_data["main_frame"]["cell5"]["diameter4"].get()]
        FinalInputs.diam6 = [controller.shared_data["main_frame"]["cell6"]["diameter1"].get(),controller.shared_data["main_frame"]["cell6"]["diameter2"].get(),controller.shared_data["main_frame"]["cell6"]["diameter3"].get(),controller.shared_data["main_frame"]["cell6"]["diameter4"].get()]
        FinalInputs.diam7 = [controller.shared_data["main_frame"]["cell7"]["diameter1"].get(),controller.shared_data["main_frame"]["cell7"]["diameter2"].get(),controller.shared_data["main_frame"]["cell7"]["diameter3"].get(),controller.shared_data["main_frame"]["cell7"]["diameter4"].get()]
        FinalInputs.diam8 = [controller.shared_data["main_frame"]["cell8"]["diameter1"].get(),controller.shared_data["main_frame"]["cell8"]["diameter2"].get(),controller.shared_data["main_frame"]["cell8"]["diameter3"].get(),controller.shared_data["main_frame"]["cell8"]["diameter4"].get()]
        FinalInputs.diam9 = [controller.shared_data["main_frame"]["cell9"]["diameter1"].get(),controller.shared_data["main_frame"]["cell9"]["diameter2"].get(),controller.shared_data["main_frame"]["cell9"]["diameter3"].get(),controller.shared_data["main_frame"]["cell9"]["diameter4"].get()]
        ...
        if socem25.core.main_funcs.overwriteGuardPage(filename_postTest_csv) == True: # filename already exists, needs to be renamed
            socem25.core.main_funcs.renamePage(self.controller.shared_data["main_frame"]["filename_postTest"]
.get()) # prompt user to rename file
    ...
    def saveEIs(self):
        ...
        ''' write CSV'''
        filename_EI_csv = self.gui_main_object.address + '/' + self.controller.shared_data["main_frame"]["filename_force"]
.get() + '_EI.csv'
    ...
    def compileNineCellData(self):
        ...
        for i in range(0,9): # FIX THIS AFTER DAQ, for EI post processing
            ...
            #print("self.controller.shared_data["main_frame"]["stemheight"]
.get()=",self.controller.shared_data["main_frame"]["stemheight"]
.get())
            #print("self.controller.shared_data["main_frame"]["barbottom"]
.get()=",self.controller.shared_data["main_frame"]["barbottom"]
.get())
            #print("self.gui_main_object.stemcounts[i]=",self.gui_main_object.stemcounts[i])
            self.gui_main_object.stemspacing_average[i], self.gui_main_object.EI_fullcontact[i], self.gui_main_object.EI_nocontact[i],self.gui_main_object.EI_intermediatecontact[i] = FinalInputs.calculateEI(float(self.gui_main_object.peaks_force[i]), self.controller.shared_data["main_frame"]["stemheight"]
.get(), self.controller.shared_data["main_frame"]["barbottom"]
.get(), self.gui_main_object.stemcounts[i])
            #print("i=",i)
            #except:
    ...
    def save_compiled(self):
        ...
        ''' write XSLX'''
        filename_compiled_xlsx = self.gui_main_object.address + '/' + self.controller.shared_data["main_frame"]["filename_force"]
.get() + '_compiled.xlsx'
        
        filename_preTest_csv = self.gui_main_object.address + '/' + self.controller.shared_data["main_frame"]["filename_preTest"]
.get() + '.csv'
        filename_forceSide1_csv = self.gui_main_object.address + '/' + (self.controller.shared_data["main_frame"]["filename_force"]
.get()) + '_side1.csv'
        filename_forceSide2_csv = self.gui_main_object.address + '/' + (self.controller.shared_data["main_frame"]["filename_force"]
.get()) + '_side2.csv'
        filename_forceSide3_csv = self.gui_main_object.address + '/' + (self.controller.shared_data["main_frame"]["filename_force"]
.get()) + '_side3.csv'
        filename_peaksSide1_csv = self.gui_main_object.address + '/' + (self.controller.shared_data["main_frame"]["filename_force"]
.get()) + '_side1_peaks.csv'
        filename_peaksSide2_csv = self.gui_main_object.address + '/' + (self.controller.shared_data["main_frame"]["filename_force"]
.get()) + '_side2_peaks.csv'
        filename_peaksSide3_csv = self.gui_main_object.address + '/' + (self.controller.shared_data["main_frame"]["filename_force"]
.get()) + '_side3_peaks.csv'
        filename_forceForward_csv = self.gui_main_object.address + '/' + (self.controller.shared_data["main_frame"]["filename_force"]
.get()) + '_forward.csv'
        filename_EI_csv = self.gui_main_object.address + '/' + self.controller.shared_data["main_frame"]["filename_force"]
.get() + '_EI.csv'
        filename_postTest_csv = self.gui_main_object.address + '/' + (self.controller.shared_data["main_frame"]["filename_postTest"]
.get()) + '.csv'
    ...
    def on_show_frame_FinalInputs(self, event):
        ...
        filename_postTest = socem25.core.main_funcs.nameBlackBox("postTest",self.controller.shared_data["main_frame"]["filename_postTest"]
.get())
        self.controller.shared_data["main_frame"]["filename_postTest"]
.set(filename_postTest)
...
.get()==1): # checks if a varietyname or plotname has been given
            self.gui_record_force_object.nameFresh(self.controller.shared_data["main_frame"]["varietyname"]
...
if __name__ == "__main__":
    ...
    app = FinalInputs(root, dummy_controller)
