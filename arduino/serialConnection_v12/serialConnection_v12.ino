...
//float calibra = -210373; // calibration factor: working well, but user can update in RPi GUI
//float calibra = -205000; // 22.18 calibration factor: working well, but user can update in RPi GUI
//float calibra = -204400; // 22.225 calibration factor: working well, but user can update in RPi GUI
float calibra = -204200; // 22.24 calibration factor: working well, but user can update in RPi GUI
...
void setup(){
    ...
    //digitalWrite(c_EncoderPinA, LOW);  // turn on pullup resistors // Bebee
